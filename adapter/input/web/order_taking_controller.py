...
from application.port.incoming.interface_order_taking import CreateOrderDTO
...
async def create_order(create_order_input: CreateOrderInput):
    ...
    order_lines_object = [OrderLine(**line) for line in create_order_object.pop("order_lines")]
